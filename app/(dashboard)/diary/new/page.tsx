...
const TRIGGER_CATEGORIES = {
    food: {
        label: '飲食',
        items: ['咖啡因', '酒精', '巧克力', '起司', '加工食品', '味精', '甜食'],
    },
    lifestyle: {
        label: '生活習慣',
        items: ['睡眠不足', '睡太多', '壓力', '過度運動', '缺乏運動', '脫水', '跳過正餐'],
    },
    environment: {
        label: '環境',
        items: ['強光', '噪音', '氣味', '氣溫變化', '濕度', '氣壓變化', '高海拔'],
    },
    hormone: {
        label: '荷爾蒙',
        items: ['月經週期', '排卵期', '更年期'],
...
export default function NewDiaryPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch('/api/headaches', {
                method: 'POST',
                ...
                body: JSON.stringify({
                    ...
                    notes: notes || null,
                    triggers: selectedTriggers.map(value => ({
